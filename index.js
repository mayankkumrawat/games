...
if (screen.availWidth <= 810 || screen.width <= 810){
    ...
    <div>
        <button  class="button"  id="left"><i class="fas fa-angle-double-left"></i></button>
        <button  class="button"  id="right"><i class="fas fa-angle-double-right"></i></button>
    </div>
...
//=============================================
if ( screen.availWidth < 810 || screen.availWidth < 810) {
